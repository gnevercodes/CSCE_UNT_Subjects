...
/*
  //demo functions of the minheap class
  MinHeap* myheap = new MinHeap();
  cout << "========================================" << endl;
  cout << "Trying some methods from the MinHeap class ...." << endl;
  ...
  for ( int i = 0; i < heapSize/2; i++ ) {
    cout << "Get and delete min element: " << myheap->extractMin() << endl;
    myheap->display();
  }
  cout << "========================================" << endl;
